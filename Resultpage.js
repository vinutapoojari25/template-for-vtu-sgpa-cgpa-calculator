window.addEventListener("load",function()
{
    ...
    if(semnum==1 ){
        document.getElementById("result").innerHTML="YOUR CGPA : "+resa;
        ...
        document.getElementById("result").innerHTML="YOUR CGPA : "+sem2th.toFixed(2);
        ...
        document.getElementById("result").innerHTML="YOUR CGPA : "+sem3th.toFixed(2);
        ...
        document.getElementById("result").innerHTML="YOUR CGPA : "+sem4th.toFixed(2);
        ...
        document.getElementById("result").innerHTML="YOUR CGPA : "+sem5th.toFixed(2);
        ...
        document.getElementById("result").innerHTML="YOUR CGPA : "+sem6th.toFixed(2);
        ...
        document.getElementById("result").innerHTML="YOUR CGPA : "+sem7th.toFixed(2);
        ...
        document.getElementById("result").innerHTML="YOUR CGPA : "+sem8th.toFixed(2);
